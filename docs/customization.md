...
Open `Set Workflow Inputs` and replace the sample values with your own source title, source type, transcript text, content goal, audience, cleanup level, and intended output.
