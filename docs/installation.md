...
This guide walks through importing the YouTube Transcript Cleaner into n8n.
...
The workflow should create a dated Google Doc with the finished youtube transcript cleaner output.
