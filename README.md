...
- Uses editable n8n inputs for source title, source type, transcript text, content goal, audience, cleanup level, and intended output
...
Raw transcripts are hard to read, quote, search, or repurpose.
